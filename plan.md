...
- Временная сортировка по имени или автору только меняет отображение и не перезаписывает сохранённый порядок.
- Новое избранное вставляется в список по своему текущему рейтингу, остальные позиции сдвигаются.
...
- Учитывать ли выдачу Ask так же, как обычный поиск. По умолчанию нет: порядок источников в ответе Ask служебный, а не рейтинг релевантности, и начисление баллов по нему добавит шум. Решение за пользователем.
