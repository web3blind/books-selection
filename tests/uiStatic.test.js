...
test('index page exposes simplified accessible AI question flow without committed secrets', () => {
  const requiredMarkers = [
    ...
    'id="readingBoundList"',
    'id="readingCheckAllButton"',
    'id="readingCheckAllStop"',
    "checkAllUnfinished: (count)",
    "checkAllStopped: (checked, total)",
    "readingCheckAllButton.addEventListener('click'",
    "checkAllRun.controller.abort()",
    'CHECK_ALL_PAUSE_MS = 1000',
    "renderCheckAllControls()",
    "loadBooks(options = {})",
    "params.set('refresh', '1')",
    "reloadButton.addEventListener('click', () => loadBooks({ refresh: true }))",
